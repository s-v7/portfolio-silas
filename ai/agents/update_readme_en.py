...
def main(output_file: Path = OUTPUT_FILE):
    ...
    print(f"[update_readme_en] provider={client.provider} model={get_model('long_markdown', client.provider)}")
    ...
    print("English README generated successfully!")
    print("REVIEW:")
    print(readme)
