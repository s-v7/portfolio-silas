...
const Projects = () => {
  ...
  const projetos2 = [
    {
      nome: "Task-Managements",
      descricao: "Aplicativo para auditoria utilizando Flask e Angular.",
      tecnologias: "Python, SQLite, Neural Networks",
      link: "https://github.com/s-v7/Task-Managements",
    },
    {
      nome: "Blockchain CREA-PI",
      descricao: "Rede Blockchain para integração de dados CREA-PI.",
  ...
  return (
    <section id="projetos" className="p-6 bg-coffee text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[...projetos, ...projetos1, ...projetos2].map((projeto, index) => (
          <div
            key={index}
